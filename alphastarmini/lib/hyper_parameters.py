...
MiniStar_Arch_Hyper_Parameters = ArchHyperParameters(batch_size=int(512 / Mini_Scale),
                                                     sequence_length=8,
                                                     max_selected=1,                                                    
                                                     max_entities=8,
                                                     minimap_size=64,                                               
                                                     embedding_size=300,  # 297 + P.action_size,  # 2129,
                                                     map_channels =1,
                                                     entity_x_y_index=24,
                                                     scalar_encoder_fc1_input=96,
                                                     scalar_encoder_fc2_input=48,
                                                     scalar_feature_size=7327,  # Deprecated
                                                     ...
                                                     winloss_baseline_input_size=160,
                                                     build_order_baseline_input_size=1216,
                                                     built_units_baseline_input_size=1152,
                                                     upgrades_baseline_input_size=1152,
                                                     effects_baseline_input_size=1152,
...
RL_Training_Hyper_Parameters = RLTrainingHyperParameters(learning_rate=1e-3,
                                                         beta1=0, 
                                                         beta2=0.99, 
                                                         epsilon=1e-5,
                                                         weight_decay=1e-5,
...
AlphaStar_Raw_Interface_Format_Params = AgentInterfaceFormatParams(feature_dimensions=sc2_env.Dimensions(screen=64, minimap=64),
                                                                   rgb_dimensions=None,
                                                                   raw_resolution=None,
                                                                   action_space=None,
...
AlphaStar_Human_Interface_Format_Params = AgentInterfaceFormatParams(feature_dimensions=sc2_env.Dimensions(screen=64, minimap=64),
                                                                     rgb_dimensions=None,
                                                                     raw_resolution=None,
                                                                     action_space=None,
                                                                     camera_width_world_units=24,
...
#                                                                     use_feature_units=True,
#                                                                     use_raw_units=True,
#                                                                     use_raw_actions=P.use_raw_action,
#                                                                     max_raw_actions=512,
#                                                                     max_selected_units=64,
#                                                                     use_unit_counts=True,
#                                                                     use_camera_position=False,
